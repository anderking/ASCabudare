...
export class PayEffects {
  ...
  create$ = createEffect(() =>
    this._actions$.pipe(
      ...
      switchMap((params) =>
        this.firebaseService.createWithFile$(params.props).pipe(
          switchMap((item: PayModel) => {
  ...
  constructor(
    ...
    private firebaseService: FirebaseService<PayModel | PayModel[]>,
