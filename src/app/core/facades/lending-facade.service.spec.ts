...
describe("LendingFacadeService", () => {
  let facadeService: LendingFacadeService;
  let store: Store;
  let spy: jasmine.Spy;
  ...
  beforeEach(waitForAsync(() => {
    ...
    facadeService = TestBed.inject(LendingFacadeService);
  ...
  describe("search", () => {
    it("should expect the search method to exist and to call the correct endpoint", () => {
      ...
      expect(collectionFB).toEqual("Lending");
    ...
    it("should return the getAll$ observable type LendingModel[]", () => {
      const mock: LendingModel[] = mockTestLendingAll;
  ...
  describe("searchOne", () => {
    ...
    it("should return the getOne$ observable type LendingModel", () => {
      const mock: LendingModel = mockTestLendingOne;
  ...
  describe("create", () => {
    ...
    it("should expect dispatch create action with the correct props", () => {
      const currentUser: CurrentUserModel = mockTestCurrentUserOne;
      const payload: LendingModel = mockTestLendingOne;
  ...
  describe("select", () => {
    ...
    it("should return the getCurrentItem$ observable type LendingModel", () => {
      const mock: LendingModel = mockTestLendingOne;
